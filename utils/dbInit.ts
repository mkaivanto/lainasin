/**
 * Derived from https://github.com/blefebvre/react-native-sqlite-demo/blob/master/src/database/DatabaseInitialization.ts
...
export class DatabaseInitialization {
  ...
  private createTables(transaction: SQLite.Transaction) {
    ...
    if (dropAllTables) {
      transaction.executeSql('DROP TABLE IF EXISTS Loan;');
